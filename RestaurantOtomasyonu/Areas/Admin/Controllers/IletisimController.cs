...
namespace RestaurantOtomasyonu.Areas.Admin.Controllers
{
    ...
    public class IletisimController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AdSoyad,Email,Telefon,Mesaj,Tarih")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdSoyad,Email,Telefon,Mesaj,Tarih")] Iletisim iletisim)
        {
            if (id != iletisim.Id)
            {
                return NotFound();
