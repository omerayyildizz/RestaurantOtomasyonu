...
namespace RestaurantOtomasyonu.Areas.Admin.Controllers
{
    ...
    public class RezervasyonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AdSoyad,Email,Telefon,Sayi,Saat,Tarih")] Rezervasyon rezervasyon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdSoyad,Email,Telefon,Sayi,Saat,Tarih")] Rezervasyon rezervasyon)
        {
