...
namespace RestaurantOtomasyonu.Areas.Admin.Controllers
{
    ...
    public class HakkimizdaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Aciklama")] Hakkimizda hakkimizda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Aciklama")] Hakkimizda hakkimizda)
        {
            if (id != hakkimizda.Id)
            {
                return NotFound();
